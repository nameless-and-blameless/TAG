...
If you've been provided a free motel or apartment, you need to read [Deadly Accomodations](/archive/etc/lodging.md) now.
...
> [!WARNING]
> You may be told to use an app for calls and texts, We strongly urge you to use your regular cell number when calling me (Kelvin). Your service and number may be the only way We can get you identified should you go missing--most have. Also, I'm a motherfucking angel, you can tell me your real names and home cities!
...
## Contacting Kelvin
If you need to contact Kelvin for any reason you can text 470-713-0020.

Other ways to contact Kelvin are [here](https://github.com/kelvinundivided).

If you sense danger, please get to public place first.
